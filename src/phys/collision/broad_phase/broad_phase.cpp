...
namespace pe_phys_collision {
    ...
    bool BroadPhaseBase::validateCollisionPair(pe_phys_object::CollisionBody* cb1, pe_phys_object::CollisionBody* cb2) const {
    ...
    bool BroadPhaseBase::testCollisionPair(pe_phys_object::CollisionBody* cb1, pe_phys_object::CollisionBody* cb2) const {
    ...
    void BroadPhaseSweepAndPrune::calcCollisionPairs(pe::Array<pe_phys_object::CollisionBody*> collision_objects) {
        clearCollisionPairs();
        ...
        std::sort(collision_objects.begin(), collision_objects.end(),
                  [this](pe_phys_object::CollisionBody* cb1, pe_phys_object::CollisionBody* cb2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            pe_phys_object::CollisionBody* cb1 = collision_objects[i];
            ...
            for (int j = i + 1; j < size; j++) {
                pe_phys_object::CollisionBody* cb2 = collision_objects[j];
