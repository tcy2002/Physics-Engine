...
void ShaderProgram::setVec3(const char* name, const pe_cg::Vector3& value) const {
    glUniform3f(glGetUniformLocation(_program_id, name), (float)value.x, (float)value.y, (float)value.z);
}

void ShaderProgram::setMat3(const char* name, const pe_cg::Matrix3x3& value) const {
    static float buf[9];
