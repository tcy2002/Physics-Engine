...
protected:
    ...
    pe::Array<pe_physics_object::RigidBody*> _rigidbodies_to_add;
    pe::Array<pe_physics_object::RigidBody*> _rigidbodies_to_remove;
...
public:
    ...
    pe_physics_object::RigidBody* getRigidBody(uint32_t idx) const { return _collision_objects[idx]; }
    ...
    PE_API void updateRigidBody(pe_physics_object::RigidBody* rigidbody);
    PE_API const pe::Array<pe_physics_object::RigidBody*>& getRigidBodiesToAdd() { return _rigidbodies_to_add; }
    PE_API void clearRigidBodiesToAdd() { _rigidbodies_to_add.clear(); }
    PE_API const pe::Array<pe_physics_object::RigidBody*>& getRigidBodiesToRemove() { return _rigidbodies_to_remove; }
