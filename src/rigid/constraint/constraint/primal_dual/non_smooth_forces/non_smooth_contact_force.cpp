#include "non_smooth_contact_force.h"
...
namespace pe_phys_constraint {
    ...
    void NonSmoothContactForce::preprocess(
            ...
            const pe::VectorX& vel, pe::Real dt, pe::Real char_mass, pe::Real char_speed) {
        // checked1
    ...
    void NonSmoothContactForce::initForces(pe::VectorX& forces, pe::VectorX& lambda) {
        // checked1
    ...
    void NonSmoothContactForce::nonSmoothResiduals(
            ...
            pe::Real mu, pe::VectorX& ru, pe::VectorX& rf, pe::VectorX& rl) {
        // checked1
    ...
    void NonSmoothContactForce::calcConstraints(const pe::VectorX& vel, const pe::VectorX& forces, const pe::VectorX& lambda) {
        // checked1
    ...
    pe::VectorX NonSmoothContactForce::calcTangentWeight(
            const pe::Array<pe_phys_collision::ContactResult*>& contacts,
            const pe::Array<pe_phys_object::RigidBody*>& objects,
            const pe::Map<pe_phys_object::RigidBody*, size_t>& object2index,
    ...
    void NonSmoothContactForce::linearSystemAddition(
            const pe::Array<pe_phys_collision::ContactResult*>& contacts,
            size_t contact_size,
            const pe::Array<pe_phys_object::RigidBody*>& objects,
            const pe::Map<pe_phys_object::RigidBody*, size_t>& object2index,
            ...
            pe::Map<pe::KV<size_t, size_t>, pe::Real*>& mat_pointers) {
        // checked1
        _sf = rf;
    ...
    void NonSmoothContactForce::retrieveNonSmoothForceInc(
            ...
            pe::Real mu, pe::VectorX& df, pe::VectorX& dl) {
        // checked1
    ...
    bool NonSmoothContactForce::filterLineSearch(
            ...
            const pe::Map<pe_phys_object::RigidBody*, size_t>& object2index,
            const pe::VectorX& vel, const pe::VectorX& forces, const pe::VectorX& lambda,
            pe::Real mu, pe::Real char_mass, pe::VectorX& du, pe::VectorX& df, pe::VectorX& dl) {
        // checked1
    ...
    pe::VectorX NonSmoothContactForce::ACVector(
            const pe::Array<pe_phys_collision::ContactResult*>& contacts,
            const pe::Array<pe_phys_object::RigidBody*>& objects,
            const pe::Map<pe_phys_object::RigidBody*, size_t>& object2index,
            const pe::VectorX& vel, const pe::VectorX& forces) {
