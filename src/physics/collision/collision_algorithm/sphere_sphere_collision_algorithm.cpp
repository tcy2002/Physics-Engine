...
bool SphereSphereCollisionAlgorithm::processCollision(pe_physics_shape::Shape* shape_a, pe_physics_shape::Shape* shape_b,
    ...
    const pe::Real radius_a = dynamic_cast<pe_physics_shape::SphereShape *>(shape_a)->getRadius();
    const pe::Real radius_b = dynamic_cast<pe_physics_shape::SphereShape *>(shape_b)->getRadius();
