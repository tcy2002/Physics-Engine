...
bool ConcaveConvexCollisionAlgorithm::processCollision(pe_physics_shape::Shape* shape_a, pe_physics_shape::Shape* shape_b,
    ...
    auto shape_concave = dynamic_cast<pe_physics_shape::ConcaveMeshShape *>(shape_a->getType() == pe_physics_shape::ShapeType::ST_ConcaveMesh ? shape_a : shape_b);
    auto shape_convex = dynamic_cast<pe_physics_shape::ConvexMeshShape *>(shape_a->getType() == pe_physics_shape::ShapeType::ST_ConvexMesh ? shape_a : shape_b);
