...
bool BoxConvexCollisionAlgorithm::processCollision(pe_physics_shape::Shape* shape_a, pe_physics_shape::Shape* shape_b,
    ...
    auto& mesh_a = shape_a->getType() == pe_physics_shape::ShapeType::ST_ConvexMesh ?
                   dynamic_cast<pe_physics_shape::ConvexMeshShape *>(shape_a)->getMesh() :
                   dynamic_cast<pe_physics_shape::BoxShape *>(shape_a)->getMesh();
    auto& mesh_b = shape_b->getType() == pe_physics_shape::ShapeType::ST_ConvexMesh ?
                   dynamic_cast<pe_physics_shape::ConvexMeshShape *>(shape_b)->getMesh() :
                   dynamic_cast<pe_physics_shape::BoxShape *>(shape_b)->getMesh();
    auto& edges_a = shape_a->getType() == pe_physics_shape::ShapeType::ST_ConvexMesh ?
                    dynamic_cast<pe_physics_shape::ConvexMeshShape *>(shape_a)->getUniqueEdges() :
                    dynamic_cast<pe_physics_shape::BoxShape *>(shape_a)->getUniqueEdges();
    auto& edges_b = shape_b->getType() == pe_physics_shape::ShapeType::ST_ConvexMesh ?
                    dynamic_cast<pe_physics_shape::ConvexMeshShape *>(shape_b)->getUniqueEdges() :
                    dynamic_cast<pe_physics_shape::BoxShape *>(shape_b)->getUniqueEdges();
