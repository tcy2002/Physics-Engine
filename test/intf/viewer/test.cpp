...
void testViewer() {
    ...
    pe_intf::Viewer::updateColor(id, pe_phys_shape::ShapeType::Cylinder, pe::Vector3(0.3, 0.3, 0.7));
    ...
    while (pe_intf::Viewer::getKeyState('q') != 0 && pe_intf::Viewer::isOpen()) {
        ...
        transform *= rotation;
        pe_intf::Viewer::updateTransform(id, pe_phys_shape::ShapeType::Cylinder, transform);
