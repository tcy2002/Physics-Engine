...
public:
    ...
    void init() override {
        ...
        auto rb3 = createBoxRigidBody(trans, pe::Vector3(PE_R(0.4), 6, PE_R(0.4)), 1);
        ...
        auto rb4 = createSphereRigidBody(trans, PE_R(0.4), 10);
        ...
        auto rb5 = createBoxRigidBody(trans, pe::Vector3(PE_R(0.4), 6, PE_R(0.4)), 1);
