...
public:
    ...
    void init() override {
        ...
        // rb1->setTransform(pe::Transform(pe::Matrix3::identity(), pe::Vector3(0, -1, 0)));
        // rb1->setKinematic(true);
        // _world.addRigidBody(rb1);

        pe::Mesh mesh;
        pe::Mesh::loadFromObj("D:\\ClionProjects\\Physics-Engine\\test\\intf\\world\\test.obj", mesh, pe::Vector3::ones());
